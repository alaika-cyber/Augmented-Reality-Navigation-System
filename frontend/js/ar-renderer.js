...
class ARRenderer {
    constructor() {
        ...
        this.colors = {
            ...
            animal:        { fill: 'rgba(255, 145, 0, 0.2)',   stroke: '#ff9100' },
            glass:         { fill: 'rgba(0, 229, 255, 0.2)',   stroke: '#00e5ff' },
            utensil:       { fill: 'rgba(124, 179, 66, 0.2)',  stroke: '#7cb342' },
            furniture:     { fill: 'rgba(141, 110, 99, 0.2)',  stroke: '#8d6e63' },
            door:          { fill: 'rgba(171, 71, 188, 0.2)',  stroke: '#ab47bc' },
            window:        { fill: 'rgba(77, 208, 225, 0.2)',  stroke: '#4dd0e1' },
            electronics:   { fill: 'rgba(38, 166, 154, 0.2)',  stroke: '#26a69a' },
            appliance:     { fill: 'rgba(78, 52, 46, 0.2)',    stroke: '#4e342e' },
            food:          { fill: 'rgba(255, 202, 40, 0.2)',  stroke: '#ffca28' },
            personal_item: { fill: 'rgba(236, 64, 122, 0.2)',  stroke: '#ec407a' },
            sports:        { fill: 'rgba(102, 187, 106, 0.2)', stroke: '#66bb6a' },
            traffic_sign:  { fill: 'rgba(255, 61, 0, 0.2)',    stroke: '#ff3d00' },
            plant:         { fill: 'rgba(76, 175, 80, 0.2)',   stroke: '#4caf50' },
            water:         { fill: 'rgba(33, 150, 243, 0.2)',  stroke: '#2196f3' },
